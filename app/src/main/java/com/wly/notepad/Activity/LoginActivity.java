...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (preferences.getBoolean("USERINFO", true)) {
            User user=null;
            user=userManage.getuser(dbHelper.getReadableDatabase(),preferences.getString("USERNAME",""),preferences.getString("PASSWORD",""));
            MainUser.user=user;
